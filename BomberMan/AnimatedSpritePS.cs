    ...
    public class AnimatedSpriteParticleSystem : DefaultAnimatedSpriteParticleSystem
    {
        ...
        public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager)
        {
            InitializeSpriteParticleSystem(cGraphicsDevice, cContentManager, 1000, 50000,
                                            "Images/Fire/AnimatedExplosion");
            SpriteBatchSettings.BlendMode = SpriteBlendMode.Additive;
            SpriteBatchSettings.SortMode = SpriteSortMode.FrontToBack;
        ...
        public void LoadExplosionEvents()
        {
            ...
            SetTexture("Images/Fire/AnimatedExplosion");
            ...
            Emitter.ParticlesPerSecond = 500; // 50;
            Emitter.PositionData.Position = new Vector3(miScreenWidth / 2, miScreenHeight / 2, 0);
            InitialProperties.LifetimeMin = 0.4f; // mcExplosionAnimation.TimeRequiredToPlayCurrentAnimation;
            InitialProperties.LifetimeMax = 0.4f; // mcExplosionAnimation.TimeRequiredToPlayCurrentAnimation;
            ...
            InitialProperties.StartColorMin = Color.Purple; // Red // Purple
            InitialProperties.StartColorMax = Color.White; // LightGoldenrodYellow; // White // Gold
            InitialProperties.EndColorMin = Color.Blue; // Blue
            InitialProperties.EndColorMax = Color.White; // White
            InitialProperties.InterpolateBetweenMinAndMaxColors = false;
            InitialProperties.StartWidthMin = 25.0f; // 100.0f;
            InitialProperties.StartWidthMax = 50.0f; // 200.0f;
            ...
            InitialProperties.EndWidthMin = 70.0f; // 200.0f;
            InitialProperties.EndWidthMax = 105.0f; // 300.0f;
        ...
        public void LoadButterflyEvents()
        {
            ...
            SetTexture("Images/AnimatedButterfly");
        ...
        public void EmitAt(GameTime gameTime, Vector3 mousePosition)
        {
            Emitter.PositionData.Position = mousePosition;

            if (ActiveParticles.Last != null)
            {
                ActiveParticles.Last.Value.Position = mousePosition;
            }
